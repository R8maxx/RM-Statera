...
/**
 * Tercera capa del aislamiento sobre el registro de vulnerabilidades.
 *
 * **Es lo más sensible que guarda el producto**, y el invariante 8 lo nombra por
 * eso: una lista de fallos sin corregir con los activos donde están es un mapa
 * para entrar. Las cuatro tablas, pivotes incluidas.
 */
return new class extends Migration
{
    ...
    private const TABLAS = [
        'vulnerabilidades',
        'vulnerabilidad_activo',
        'vulnerabilidad_transiciones',
