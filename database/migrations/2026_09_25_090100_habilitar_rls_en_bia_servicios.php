...
/**
 * Tercera capa del aislamiento sobre el BIA por servicio.
 *
 * **Las dos la llevan, la de histórico incluida.** El impacto que un cliente
 * declara si un servicio se cae es información de su propio análisis de
 * continuidad; filtrarla a otra organización es de lo peor que este producto
 * puede hacer.
 */
