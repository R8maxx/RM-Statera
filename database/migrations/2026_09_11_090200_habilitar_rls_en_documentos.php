...
/**
 * Tercera capa del aislamiento sobre los documentos y sus versiones, con el
 * mismo patrón de `2026_09_09_110100_habilitar_rls_en_evidencias.php`.
 *
 * Las versiones la llevan igual que la serie: una versión contiene la SoA entera
 * de una organización —su alcance, sus exclusiones y sus huecos—, así que leerla
 * entre tenants filtraría más que leer el registro que la nombra.
 */
return new class extends Migration
{
    /** @var list<string> */
    private const TABLAS = ['documentos', 'documento_versiones'];
