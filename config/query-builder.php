...
return [
    ...
    /*
     * Statera: un parámetro no declarado se ignora, no rompe la petición.
     *
     * La alternativa —400 Bad Request— convierte cualquier URL guardada en un
     * error en cuanto se renombra un filtro o deja de ser ordenable una
     * columna. Silencioso tampoco es: `MetaTabla` devuelve el orden y los
     * filtros que se aplicaron DE VERDAD, así que la interfaz refleja el estado
     * real y no el que se pidió.
     */
