...
13. ✅ Contexto de la organización (§ 4.1): el DAFO, las partes interesadas con
    ...
    que cada módulo aporta al panel —cumplimiento, inventario, plan de acción, no
    conformidades y contexto—; faltan los indicadores con objetivo y periodicidad
    y las series históricas, que son otra cosa.
